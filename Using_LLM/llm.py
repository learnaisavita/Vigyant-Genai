"""Unified LLM access : one chat() call, three providers.
...
time would be repetitive and error prone. So we hide all of it behind a single
function, chat(messages), and pick the provider from configuration. 
