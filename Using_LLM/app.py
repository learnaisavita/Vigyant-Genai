""" one LLM wrapper behind a small Streamlit web page.
...
how long it took. It is  notebook's wrapper turned into a tiny app.
...
root . Every call is logged with provider, token counts, cost,
and latency.
"""
